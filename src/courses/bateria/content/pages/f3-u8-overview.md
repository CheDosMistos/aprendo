---
contentId: bat-f3-u8-overview
courseId: bateria
phase: 3
unit: 8
unitSlug: fase-3-unidad-8
slug: fase-3-unidad-8-introduccion
kind: unit
order: 0
...
- **INTENCIÓN:** qué querías que ocurriera;
- **NOTACIÓN/REPRESENTACIÓN:** qué dejaste fijado;
- **EJECUCIÓN:** qué ocurrió realmente al tocar.

Un error de ejecución no se convierte automáticamente en una revisión compositiva. Puede convertirse en material si después decides conservarlo, lo representas y lo integras.

## Revisar no significa hacer más difícil
