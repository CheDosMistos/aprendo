---
contentId: bat-f6-u6-l2
courseId: bateria
phase: 6
unit: 6
unitSlug: fase-6-unidad-6
slug: cues-responder-continuar
kind: lesson
order: 2
title: "Cues: detectar, decidir, responder y seguir"
summary: "Entrena entradas, cortes, transiciones y endings como información que debe convertirse en acción sin perder el siguiente punto de la forma."
duration: 20–30 min
competencies: [I6, E5, F7, H5, H6, C1, C2]
rudiments: []
published: true
---
...
Responder a una señal musical sin convertir la respuesta en un evento aislado: **detectar, comprender, actuar y continuar**.
...
Un corte bien tocado seguido de una reentrada perdida sigue siendo una respuesta incompleta.
...
Para cada evento registra sólo:

`SEÑAL → FUNCIÓN → RESPUESTA → ¿SE MANTUVO LA FORMA?`
...
- tocar el cue pero perder el compás siguiente;
- responder tarde porque primero se intenta nombrar intelectualmente la señal;
...
- 2 min — revisar forma y tipos de señal;
- 6 min — una toma continua con 3–4 cues;
- 2 min — identificar el fallo dominante;
- 3 min — segunda toma corrigiendo sólo esa variable.

## MÍNIMO PARA AVANZAR

- detectas varias clases básicas de cue en tareas adecuadas;
- distingues la señal de su función;
- tu respuesta es temporalmente compatible con el evento;
- mantienes o recuperas inmediatamente la forma posterior;
- un fallo pequeño no te obliga a detener la interpretación;
- puedes explicar una respuesta que deliberadamente consistió en tocar menos o no cambiar.
