---
contentId: bat-f5-u5-overview
courseId: bateria
phase: 5
unit: 5
unitSlug: fase-5-unidad-5
slug: fase-5-unidad-5-introduccion
kind: unit
order: 0
...
**CORE — funk / soul / R&B como familia de escucha y transferencia.**

Berklee describe el funk como un lenguaje que **a menudo** presenta feel de semicorchea y subraya que el estilo depende del conjunto, no sólo del baterista. Esa formulación es importante: aquí no convertimos una rejilla ni un patrón en definición universal del género.

Fuente verificada: [Berklee Online — Funk and Rock Drum Rhythms](https://online.berklee.edu/takenote/basic-funk-for-drums/).

## Qué significa “pocket” en esta unidad

En Aprendo usamos `pocket` como **etiqueta pedagógica de relación funcional entre pulso, capas, dinámica, articulación y continuidad**. No lo reducimos a tocar tarde, adelantado ni a un desplazamiento temporal fijo.

Por eso la jerarquía será:

`PULSO → CAPA ESTABLE → RELACIÓN ENTRE VOCES → DINÁMICA/ARTICULACIÓN → DENSIDAD`.
...
- declara funk, soul o R&B dominados;
