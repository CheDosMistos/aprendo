...
- distingues 6/8 de 3/4 y de un tresillo aislado en 4/4;
- puedes leer o cantar una línea corta en 6/8 conservando sus dos pulsos principales;
...
- puedes identificar si un fallo procede principalmente de ornamentación, alturas, sticking, dinámica o tiempo.

## AVANZADO

Sin ser requisito:

- inicias muestras con ambas manos cuando PAS lo permite;
- produces dos transformaciones distintas de un mismo motivo conservando 6/8;
- comparas 6/8, 3/4 y tresillos en 4/4 con vocabulario preciso.
