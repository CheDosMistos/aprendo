...
Usa una rejilla conocida y una longitud manejable. Crea un motivo A que puedas:

- escribir de forma reproducible;
- tocar varias veces;
- reconocer después de una interrupción breve.

Antes de continuar, escribe **dos rasgos que sostienen su identidad**. No valen porcentajes de notas iguales.

Ejemplos de rasgos observables: comienzo, cierre, patrón de silencios, densidad, agrupación o distribución de ataques.

# 2. REPITE A

Toca A dos veces de manera deliberadamente literal.

Registra:

- `REPETICIÓN ESTABLE`;
- `CAMBIO ACCIDENTAL LOCALIZADO`;
- `A TODAVÍA INESTABLE`.

Si A todavía deriva de forma no intencional, reduce densidad antes de añadir contraste.

# 3. CREA B

Construye un material contrastante B.

El contraste debe ser **deliberado y explicable**, no necesariamente más denso o más difícil.

Completa: **“B contrasta con A porque…”**
...
- identidad del último A;
- recuperación después de B;
- continuidad temporal;
- claridad del contraste.

Graba una toma si puedes y conserva la primera antes de hacer una revisión.

---

# 5. CLASIFICA UNA VARIANTE NUEVA
...
<details>
<summary>Mostrar referencia editorial del ejercicio</summary>
...
1. motivo A escrito y tocable;
2. repetición literal deliberada;
3. contraste B deliberado;
4. retorno A reconocible;
5. explicación de al menos dos rasgos de identidad de A;
6. clasificación razonada de C/X;
...
- puedes separar repetición de contraste;
- recuperas A después de B al menos con correctivos localizados;
