---
contentId: bat-f6-u6-overview
courseId: bateria
phase: 6
unit: 6
unitSlug: fase-6-unidad-6
slug: fase-6-unidad-6-introduccion
kind: unit
order: 0
...
> **ESCUCHAR INFORMACIÓN EXTERNA → INTERPRETAR SU FUNCIÓN → DECIDIR → MODIFICAR LA EJECUCIÓN → MANTENER LA MÚSICA → EVALUAR LA RESPUESTA**

Interacción no significa tocar muchas cosas a la vez ni «encajar» cada golpe con otro instrumento. Significa conservar una representación suficiente de pulso y forma mientras atiendes a señales relevantes y cambias una decisión musical por ellas.

## Bajo y batería: relación, no fórmula
...
Una pista fija puede exigir atención y respuesta auténticas por parte del alumno, pero no puede modificar su comportamiento como consecuencia de lo que el alumno acaba de tocar.

Por eso distinguimos:

- **simulación programada:** información externa predeterminada;
...
- adaptación interpersonal completa;
- negociación musical bidireccional;
- liderazgo/seguimiento que cambia por la conducta de otro músico real;
...
- 4–5 min — mapa de pulso/forma + objetivo de escucha;
- 7–8 min — bajo o cue como fuente prioritaria;
- 8–10 min — respuesta contextual con densidad/dinámica;
- 4–5 min — toma continua + revisión de una decisión.
...
> **INTERACTUAR = CAMBIAR ALGO POR INFORMACIÓN MUSICAL RELEVANTE SIN DEJAR DE SOSTENER LA MÚSICA.**
