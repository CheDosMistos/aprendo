---
contentId: bat-f2-u10-overview
courseId: bateria
phase: 2
unit: 10
unitSlug: fase-2-unidad-10
slug: fase-2-unidad-10-introduccion
kind: unit
order: 0
...
`VOLVER A REFERENCIA MÁS EXPLÍCITA ≠ FRACASAR`.
...
1. si el pulso cambia cuando desaparecen apoyos;
2. si la subdivisión interna sigue disponible;
3. si hay continuidad;
4. qué ocurre cuando el click reaparece;
5. si la lectura conocida sigue siendo realmente conocida;
6. tensión y sonido suficiente.
