---
contentId: bat-f5-u11-overview
courseId: bateria
phase: 5
unit: 11
unitSlug: fase-5-unidad-11
slug: fase-5-unidad-11-introduccion
kind: unit
order: 0
...
competencies: [I3, I4, D7, D5, H5, H6, H7, H8, K2, K5, K6, F3, I6]
rudiments: []
published: true
---
...
Pieza C es una pieza original de 32 compases en 4/4:

`INTRO 4 → A 8 → B 8 → A' 8 → OUTRO 4`.

No es una transcripción ni pretende representar un género concreto. Reutiliza materiales ya conocidos para que la dificultad dominante sea **integrar información y conservar la forma**.

### Material musical ya conocido

- backbeat binario sencillo;
- una capa de corcheas o semicorcheas sostenible;
- variación simple de bombo;
- dinámica entre secciones;
- fill corto de transición;
- retorno al 1;
- recuperación después de un error local.

## Las cuatro fuentes de información

Pieza C se aprende desde cuatro perspectivas complementarias:

1. **escucha:** playback original del score para obtener una primera hipótesis;
2. **chart:** forma, cues y prioridades sin notación exhaustiva de cada golpe;
3. **memoria/análisis:** mapa de secciones, contrastes y puntos de riesgo;
4. **grabación:** comparar lo que creías tocar con lo que realmente ocurrió.

> **NINGUNA FUENTE ES “LA MÚSICA ENTERA”.**
...
Cuando aparezca demasiada información:

`TIEMPO → FORMA → ENTRADAS → GROOVE/FEEL → DINÁMICA → FIGURES/FILLS → DETALLE`
...
`FORMA / TIEMPO / CONTINUIDAD / RECUPERACIÓN / USO DE FUENTES / DECISIÓN MUSICAL / DINÁMICA / SONIDO / REGISTRO / RETENCIÓN`
