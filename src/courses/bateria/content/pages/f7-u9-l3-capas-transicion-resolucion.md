...
La partitura original propone:

1. 4/4 con ciclo de acento cada 3 semicorcheas;
2. el mismo ciclo continúa sin reiniciarse en la barra;
3. 3:2 en dos voces simultáneas;
4. corcheas de tresillo como duración puente;
5. modulación: `corchea de tresillo antigua = corchea nueva`, negra `120 → 180`;
6. regreso deliberado a negra `120`.

La finalidad no es demostrar que puedes encadenar tres técnicas. La finalidad es construir:
...
- el ciclo de 3 semicorcheas no se reinicia en cada `1`;
- su fase cambia respecto a la barra.
...
- capa superior: 3 ataques en el tiempo de 2 negras;
- capa inferior: 2 pulsos en ese mismo ciclo;
- ambas comparten fronteras de ciclo.
...
La duración puente permanece; lo que cambia es qué unidad se interpreta como pulso nuevo.

## EJERCICIO ORIGINAL CREADO PARA ESTE CURSO — E: tres diagnósticos distintos
...
Si respondes las tres preguntas con la misma explicación, estás borrando diferencias conceptuales.

## EJERCICIO ORIGINAL CREADO PARA ESTE CURSO — F: transiciones, no sólo bloques
...
Después recompón los seis compases.

La integración suele fallar en las **transiciones**, aunque cada bloque aislado funcione.
...
La partitura contiene cambios de tempo reales.

Procedimiento:

1. escucha una vez sin tocar;
2. marca con la mano la negra a 120;
3. durante el puente, sigue la duración de la corchea de tresillo;
4. comprueba que esa duración coincide con la nueva corchea a 180;
5. toca;
6. vuelve a escuchar tu grabación sin mirar la pantalla.

## Oído — cambio de foco

En la escucha del compás 3:

- primera pasada: atiende sólo a la capa de 2;
- segunda: sólo a la capa de 3;
- tercera: escucha la relación completa.

Después, en compases 4–5, cambia de pregunta:

- ya no buscas dos capas;
- buscas una **duración puente** que cambia de función.
...
La recuperación debe respetar **qué tipo de problema** ha fallado.
