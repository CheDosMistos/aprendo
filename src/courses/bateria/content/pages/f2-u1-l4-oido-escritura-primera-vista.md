---
contentId: bat-f2-u1-l4
courseId: bateria
phase: 2
unit: 1
unitSlug: fase-2-unidad-1
slug: oido-escritura-y-primera-vista
kind: lesson
order: 4
...
Aquí no eliges entre opciones visibles. Debes pasar del sonido a una representación propia.
...
Puedes repetir el estímulo. **Esto es entrenamiento, no una prueba estandarizada de memoria.** Si necesitas tres escuchas para representar bien la célula, registra ese dato sin convertirlo en una nota global.

### Dictado A

<div data-rhythm-dictation data-bpm="66" data-subdivision="2" data-pattern="10100110" data-answer="Ataques en 1, 2, &amp; de 3 y 4. Rejilla de corcheas: X · X · · X X ·."></div>

### Dictado B

<div data-rhythm-dictation data-bpm="66" data-subdivision="2" data-pattern="01101001" data-answer="Ataques en &amp; de 1, 2, 3 y &amp; de 4. Rejilla de corcheas: · X X · X · · X."></div>

No te puntúes por copiar exactamente una convención gráfica a la primera. Lo importante aquí es comprobar si **el sonido conserva pulso, posiciones de ataque y silencios cuando lo conviertes en escritura**.
...
1. **4/4:** hay cuatro pulsos de negra en total;
2. **duración total:** ninguna figura o silencio hace que el compás quede corto o largo;
3. **ataques/silencios:** puedes señalar exactamente dónde ocurre cada uno;
4. **legibilidad:** otra persona podría interpretar lo que pretendías sin que se lo explicaras de memoria.
...
- configura un click convencional en negras si lo necesitas;
- elige un tempo cómodo como condición de observación, no como meta;
- recuerda que continuidad y precisión se registrarán por separado.

Cuando pulses **Empezar**:

1. mira brevemente la línea completa;
2. localiza el pulso y la subdivisión necesaria;
3. toca de principio a fin con sticking alternado sencillo;
...
- **CONTINUIDAD / RECUPERACIÓN:** si mantuviste el flujo, si te detuviste, y si pudiste reincorporarte después de un error.
...
Sobre ocho corcheas uniformes dentro de **4/4**, agrupa mentalmente los ataques como:

**3 + 3 + 2**

Puedes marcar el inicio de cada grupo en:
...
No conviertas haber terminado la página en evidencia automática. Registra muestras concretas:
