...
Una toma o evidencia equivalente de material conocido con condiciones suficientemente declaradas.

Debe permitir comparar después sin presentar una toma favorable como prueba definitiva de retención.

### 2. Problema dominante

Una formulación concreta y observable.

Ejemplo válido:

`el retorno al 1 falla después de dos de las tres transiciones con fill`.
...
- existe una línea base interpretable;
- has formulado un problema real sin confundirlo automáticamente con su causa;
...
Es la **línea base desde la que esas capacidades empezarán a integrarse durante Fase 6**.

> **AVANZAR NO SIGNIFICA HABER RESUELTO TODOS LOS PROBLEMAS; SIGNIFICA TENER UN PROCESO SUFICIENTEMENTE CLARO PARA APRENDER DEL SIGUIENTE.**
