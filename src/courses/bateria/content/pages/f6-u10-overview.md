...
### EVIDENCIA — anticipación durante lectura musical

La revisión de Perra et al. (2021) sobre *eye-hand span* concluye que, durante lectura a primera vista, la mirada suele adelantarse a lo que se está ejecutando y que ese margen se adapta a la dificultad. La mayor parte de la evidencia procede de pianistas; por tanto, **no demuestra una distancia visual óptima para drum charts**. Sí apoya una idea transferible: anticipar landmarks y complejidades próximas es parte de una lectura funcional, y la cantidad de información anticipada debe ajustarse a la carga.

Fuente: https://doi.org/10.16910/jemr.14.4.4

### EVIDENCIA — pista fija e interacción bidireccional no son equivalentes

Demos et al. (2017) compararon pianistas tocando con un compañero en vivo y con grabaciones del mismo compañero. La condición grabada obligaba a una adaptación unidireccional; en vivo era posible el acoplamiento bidireccional. **Límite:** son duetos de piano, no batería-bajo. La implicación curricular sí es clara: una fuente no responsiva puede entrenar respuesta a información externa, pero no demuestra adaptación mutua.

Fuente: https://doi.org/10.3389/fpsyg.2017.00149

### EVIDENCIA / MARCO TEÓRICO — resiliencia ante lo inesperado

Glowinski et al. (2016) describen el ensemble como sistema resiliente capaz de anticipar, monitorizar, responder y aprender ante perturbaciones. Es un marco teórico, no un ensayo que prescriba un protocolo concreto para bateristas. Refuerza que la recuperación musical puede evaluarse por la capacidad de proteger la actividad conjunta, no sólo por evitar errores.

Fuente: https://doi.org/10.3389/fpsyg.2016.01548
...
### EJERCICIO ORIGINAL CREADO PARA ESTE CURSO — «Proyecto Horizonte»

Chart funcional de forma:

`INTRO 4 | A 8 | A' 8 | B 8 | C 8 | B' 8 | A 8 | OUTRO 4`

No es una transcripción de ninguna canción ni una reconstrucción de una partitura existente.

El chart **no prescribe cada golpe**. Prescribe función, landmarks y ventanas de decisión. En cada sección elegirás vocabulario ya conocido de un estilo que ya tengas disponible.

| Sección | Función | Información imprescindible |
|---|---|---|
| INTRO | establecer referencia y carácter | entrada clara + dinámica inicial |
| A | groove base | estabilidad + espacio |
| A' | misma función con primera variación | conservar identidad |
| B | contraste/lift | cambio de energía o textura |
...
Si no dispones de otro músico, la unidad puede completarse. Registra:
...
- no reproduce transcripciones protegidas;
- no convierte una pista fija en interacción interpersonal;
