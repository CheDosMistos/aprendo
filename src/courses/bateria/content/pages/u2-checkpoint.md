...
### 3. Lectura nueva con silencios — 2–3 min
...
Formula al menos un problema como:

**SÍNTOMA → HIPÓTESIS → PRUEBA**

Por ejemplo, diferencia un fallo de tiempo de uno de sticking o de lectura antes de decidir qué repetir.
...
- que una mano sea menos consistente;
- que el ternario todavía resulte menos natural que el binario;
- que necesites tempos lentos;
- que una lectura requiera más de un intento.

## Cómo interpretar la evidencia

- **Evidencia reciente y representativa:** se reutiliza; no se repite por calendario.
- **Evidencia dudosa:** se remuestrea con una tarea corta.
- **Muestreo parcial:** solo actualiza las habilidades realmente observadas.
- **Una toma aislada atípica:** genera diagnóstico/retest antes de degradar un estado previamente estable.
- **Retención:** requiere separación; hacerlo bien justo después de practicar no la demuestra.
...
Si tienes dudas sobre cualquiera de los seis rudimentos, vuelve a la fuente normativa:
