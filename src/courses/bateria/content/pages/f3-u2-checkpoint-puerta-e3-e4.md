...
> **dictado/relación entre oído y notación están suficientemente disponibles para que Unidad 3 pueda introducir transcripción real —transcripción iterativa— sin que toda la carga recaiga en imitación, memoria o notación básica.**
...
`ESCUCHAR TODO → IMITAR/ESBOZAR → CHUNKS SI SON NECESARIOS → ESCRIBIR → TOCAR TU RESPUESTA → REVELAR → COMPARAR`

Registra escuchas completas, chunks, posiciones dudosas, legibilidad y variable limitante.

## EVIDENCIA B — mayor longitud
...
`ESCUCHAR A+B → PRIMERA HIPÓTESIS → SEGMENTAR POR COMPÁS SI HACE FALTA → ESCRIBIR A+B → TOCAR → REVELAR → COMPARAR`

## Pregunta diagnóstica

Elige la limitación dominante y justifícala con una observación concreta:

`PERCEPCIÓN / MEMORIA / NOTACIÓN / TIEMPO / EJECUCIÓN / ATENCIÓN`
...
Reconstruyes material breve con ayudas razonables, tu representación es interpretable, puedes tocarla y localizas el problema dominante.
...
La reconstrucción breve colapsa globalmente porque una dependencia imprescindible todavía no está disponible.
...
- reconstruyes una parte sustancial de ambos compases de B con ayudas explícitas;
