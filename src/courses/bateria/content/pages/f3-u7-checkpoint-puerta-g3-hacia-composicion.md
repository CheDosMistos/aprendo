...
# 1. DECLARA LA RESTRICCIÓN

Elige **una**:

- A + una transformación;
- longitud fija + retorno a A;
- densidad limitada;
- silencio obligatorio;
- dos transformaciones posibles;
- objetivo formal/dinámico ligero.
...
# 2. IMPROVISA UNA TOMA

No escribas la respuesta completa antes.

Durante la toma:

- mantén el tiempo;
- simplifica si hace falta;
- recupera;
- termina la frase;
- no pares a corregir detalles.

# 3. GUARDA Y ESCUCHA

Conserva al menos una toma con Practice Recorder.

Después registra por separado:

- `CONTINUIDAD`;
- `CONSIGNA`;
- `MOTIVO/VOCABULARIO`;
- `RECUPERACIÓN`;
- `ESPACIO/DINÁMICA` cuando proceda;
- `CIERRE`.

# 4. DECISIÓN Y ACCIDENTE

Identifica:

- una decisión deliberada;
- un accidente si lo hubo;
- cómo te recuperaste;
...
- respetas la consigna de forma reconocible;
- mantienes o recuperas referencia temporal;
- usas vocabulario reconocible;
- puedes explicar una decisión y distinguirla de accidente;
- conservas una toma;
- señalas qué podrías fijar después como material compositivo.

## COMPETENTE

Mantienes pulso, frase/forma y vocabulario durante varias tomas con restricciones más ligeras; recuperas errores locales y puedes variar respuestas sin perder el marco.
