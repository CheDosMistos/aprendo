---
contentId: bat-f2-u5-check
courseId: bateria
phase: 2
unit: 5
unitSlug: fase-2-unidad-5
slug: puerta-de-reorganizacion-del-pulso
kind: checkpoint
order: 5
...
1. elige una negra cómoda;
2. localiza los cuatro pulsos de cada compás;
3. toca sólo el **compás 1** y comprueba si las tres partes de cada pulso son razonablemente iguales;
4. toca después los compases 2–4 sin cambiar deliberadamente la negra;
5. si la línea completa es demasiado larga, usa primero el compás 2 como muestra `2↔3` y después uno de los compases que incorpora `4`;
6. ante un error pequeño, intenta conservar o recuperar la referencia de pulso;
7. habilita playback sólo después de una primera tentativa propia y úsalo como feedback.
...
Una repetición posterior puede mejorar la práctica, pero no es una segunda muestra independiente.

## 2. Muestra B — microtarea auditiva ternaria — 2–3 min

Escucha una célula de **dos pulsos**, cada uno dividido en tres posiciones iguales. No mires la respuesta antes de decidir.

Protocolo:

1. usa los cuatro pulsos de entrada para fijar la negra;
2. escucha el estímulo completo sin tocar;
3. mantén internamente `1-la-li | 2-la-li` o una vocalización equivalente;
4. escribe seis posiciones y marca ataque `X` o silencio `·`;
5. repite el estímulo sólo si lo necesitas;
6. pulsa **Mostrar respuesta** después de haber escrito tu versión.

<div data-rhythm-dictation data-bpm="58" data-subdivision="3" data-pattern="101011" data-answer="X · X | · X X — dos pulsos ternarios; tres posiciones iguales dentro de cada pulso."></div>
...
## 3. Explicación conceptual — qué permanece y qué cambia — 2 min

Responde con tus palabras:

> **Cuando pasas de 2 a 3 o de 3 a 4 partes dentro de una negra, ¿qué permanece y qué cambia?**

Una respuesta suficiente distingue dos capas:

- **PERMANECE:** el inicio del pulso, el final del pulso y la referencia temporal de la negra;
- **CAMBIA:** el número de partes internas, la distancia entre ataques y la notación necesaria para representarlas.

Ahora añade esta segunda comprobación:

> **Si dos pulsos de negra contienen tres ataques cada uno, ¿eso significa que hay seis pulsos principales?**
...
Antes de aumentar novedad, reduce o detén carga si aparece dolor, hormigueo, entumecimiento, pérdida de fuerza, deterioro técnico fuerte por fatiga o tensión persistente. Si una señal persiste, corresponde valoración sanitaria; el curso no la diagnostica.
...
- mantener una referencia de negra suficientemente estable durante una línea corta;
- producir y leer tres partes razonablemente iguales dentro de un pulso;
- reconocer un tresillo básico como relación `3:2`;
- cambiar al menos `2↔3` sin mover sistemáticamente el inicio y final del pulso;
- afrontar una muestra corta `2↔3↔4` reduciendo longitud si hace falta;
- distinguir por oído pulso principal y tres posiciones internas en una célula breve;
- explicar con claridad qué **permanece** y qué **cambia** al reorganizar la subdivisión;
- distinguir `seis ataques/subdivisiones` de `seis pulsos principales`;
- localizar si el fallo dominante fue pulso, subdivisión, lectura, oído, memoria, ejecución o comprensión.

No se exige:

- cero errores;
- un BPM fijo, universal o alto;
- cambios rápidos `2↔3↔4`;
- sextillos;
- 6/8 dominado;
- 9/8 o 12/8;
