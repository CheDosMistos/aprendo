...
> **¿LA EVIDENCIA ACUMULADA MUESTRA QUE PUEDO APRENDER, ANALIZAR, REVISAR Y TRANSFERIR MÚSICA CON AUTONOMÍA FUNCIONAL?**

## Dos puertas distintas que deben conservarse
...
- transcripciones propias identificadas correctamente;
- registros de hipótesis → prueba → resultado;
...
No se exige una canción diferente para cada carril.
...
Lo que se evita es reconstruir exactamente la tarea durante un bloque largo justo antes de “probar” si estaba retenida.

El sistema del curso no fija 24 h, 48 h ni otro intervalo universal. Se busca separación suficiente para que la prueba aporte información sobre recuperación y no sólo sobre rendimiento inmediatamente preparado.
...
- mismo principio en otra sección;
- misma función con menos apoyo;
- mismo proceso diagnóstico aplicado a material anterior;
- misma idea transferida a otro contexto ya documentado;
- entrada desde otro punto de la forma;
- adaptación de una solución a una condición musical compatible.
...
- ¿qué ayudas puedes retirar?;
- ¿qué diferencia haces ahora entre rendimiento, retención y transferencia?;
- ¿cómo manejas incertidumbre?;
- ¿qué problema sigue abierto y qué harás con él?
...
> **CERRAR FASE 6 NO SIGNIFICA “YA NO TENGO NADA QUE MEJORAR”; SIGNIFICA QUE TENGO EVIDENCIA SUFICIENTE PARA APRENDER Y REVISAR LO SIGUIENTE CON AUTONOMÍA FUNCIONAL.**
