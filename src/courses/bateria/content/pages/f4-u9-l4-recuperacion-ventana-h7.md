...
Mantener la forma cuando el fill contiene un error menor.

La prioridad de hoy es:

> **NO CONVERTIR UN ERROR DEL FILL EN LA PÉRDIDA DEL COMPÁS SIGUIENTE.**
...
Si una nota del fill falla:

1. no intentes “recuperar” la nota perdida metiendo otra fuera de sitio;
2. conserva la subdivisión si puedes;
3. anticipa el siguiente 1;
4. entra de nuevo en el groove;
5. analiza el error después.

Esto es **modo interpretación**.

## Correctivo posterior

Después de la toma, clasifica el síntoma:

`ENTRADA / DURACIÓN / RECORRIDO / SUBDIVISIÓN / 1`.
...
- pedal hi-hat en negras continuas durante los dos compases;
...
- practicada de antemano;
- limitada a una única combinación.
...
- ante un error menor, intentas conservar o recuperar una referencia clara;
- priorizas el siguiente 1;
- continúas el groove tras el fill;
- diagnosticas el fallo después;
- corriges una sola unión y recompones.
