---
contentId: bat-f3-u2-overview
courseId: bateria
phase: 3
unit: 2
unitSlug: fase-3-unidad-2
slug: fase-3-unidad-2-introduccion
kind: unit
order: 0
...
> **Novedad dominante:** reconstrucción auditiva mediante segmentación funcional.
...
`CÉLULA → CHUNK DE PULSO → COMPÁS → DOS COMPASES`
...
- intentar primero el estímulo completo;
- usar chunks sólo cuando aportan información;
- volver al conjunto después de trabajar por partes;
- conservar la primera hipótesis;
- distinguir percepción, memoria, notación, tiempo y ejecución;
- registrar escuchas completas y ayudas por separado.

## No convertimos ayudas en castigos

No existe un número universal de escuchas para aprobar. Marcar pulso o vocalizar puede ayudar, pero no es ritual obligatorio. “Menos escuchas” tampoco equivale automáticamente a mejor aprendizaje.
