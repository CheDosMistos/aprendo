---
contentId: bat-f4-u3-overview
courseId: bateria
phase: 4
unit: 3
unitSlug: fase-4-unidad-3
slug: fase-4-unidad-3-introduccion
kind: unit
order: 0
...
- una configuración asiento–pie–pedal que puedas reajustar;
- golpes simples repetibles;
- control básico del retorno del pedal y del sonido;
- negras y corcheas de bombo dentro de un pulso conocido;
- una primera sustitución de notas manuales conocidas por bombo.

## Técnica por resultados, no por dogma

La investigación específica disponible no demuestra que heel-down, heel-up, heel-toe, slide u otra mecánica sea universalmente superior para principiantes.

Por eso evaluaremos:

`CONTROL / SONIDO / DINÁMICA / RETORNO / EQUILIBRIO / TENSIÓN / TIEMPO`
...
Produces golpes de bombo suficientemente consistentes en patrones básicos, puedes detectar el cuello de botella principal y aplicar un correctivo de una sola variable sin depender de velocidad alta.
