---
contentId: bat-f3-u3-overview
courseId: bateria
phase: 3
unit: 3
unitSlug: fase-3-unidad-3
slug: fase-3-unidad-3-introduccion
kind: unit
order: 0
...
- **grave:** capa baja;
- **media:** capa intermedia;
- **aguda:** capa alta.

No afirmamos que estos sonidos sean una reproducción acústica exacta de bombo, caja y hi-hat. Su función es permitir aprender el proceso de transcripción por capas sin copyright externo ni necesidad de kit.

La solución escrita muestra el **esqueleto compuesto de ataques**, ejecutable en pad. Al revelar aparece también el mapa exacto de las tres capas.
...
6. cambia sólo lo que la nueva evidencia justifique;
7. toca en pad el esqueleto que escribiste;
8. vuelve a la fuente completa;
...
- primera hipótesis antes de revelar;
...
Otra fuente equivalente, más detalle de capas o una comparación entre dos notaciones posibles.
