---
contentId: bat-f6-u8-overview
courseId: bateria
phase: 6
unit: 8
unitSlug: fase-6-unidad-8
slug: fase-6-unidad-8-introduccion
kind: unit
order: 0
...
## La rejilla es una referencia, no una definición de musicalidad

Una visualización de DAW, una onda o un click pueden ayudar a describir cuándo ocurrió un ataque. No determinan por sí solos si una interpretación tiene mejor groove, mejor feel o mayor pertinencia estilística.

La investigación perceptiva y de performance obliga a evitar dos simplificaciones opuestas:

- `CUANTIZADO = SIN GROOVE`;
- `MÁS DESVIACIÓN = MÁS GROOVE`.

En estudios con rhythm section, versiones cuantizadas y versiones con microtiming humano pueden producir experiencia de groove, y aumentar artificialmente desviaciones no garantiza mejorarla. Por tanto no existe un objetivo universal de “humanizar X ms”.

## Delante / centro / detrás: relación, no cambio de tempo

En esta unidad `pushed`, `on-beat/centered` y `laid-back` se usan como **descriptores relativos dentro de tareas controladas**, no como recetas estilísticas.

Tocar detrás no significa arrastrar progresivamente el tempo. Tocar delante no significa acelerar. La referencia temporal global debe seguir siendo suficientemente estable para que la colocación sea una relación perceptible y no una deriva.
...
- 4–5 min — estabilizar pulso/subdivisión y declarar la referencia;
- 7–8 min — comparación A/B de una sola variable;
- 8–10 min — aplicación musical con grabación;
- 4–5 min — escuchar, describir y decidir qué repetir o descartar.
...
> **FEEL NO ES “SER IMPRECISO”: ES UNA RELACIÓN MUSICAL QUE DEBE CONSERVAR SUFICIENTE ESTABILIDAD PARA PODER SER PERCIBIDA, COMPARADA Y ELEGIDA.**
