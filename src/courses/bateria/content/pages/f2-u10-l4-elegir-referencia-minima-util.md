---
contentId: bat-f2-u10-l4
courseId: bateria
phase: 2
unit: 10
unitSlug: fase-2-unidad-10
slug: elegir-referencia-minima-util
kind: lesson
order: 4
title: "Elegir la referencia mínima útil"
summary: "Compara referencia completa, 2 y 4, half-time y gap para elegir la retirada de ayuda que desafía el tiempo sin destruir la lectura."
duration: 25–30 min
...
Cambia sólo la referencia:

1. completa;
2. 2 y 4;
3. half-time 1 y 3;
4. gap 1 compás sí / 1 no.

No necesitas completar los cuatro modos si una condición ya hace que el pulso deje de ser interpretable.

## Diagnóstico

Pregunta:

- ¿qué modo exige atención sin provocar persecución del click?;
- ¿en cuál mantienes subdivisión sin depender de cada confirmación?;
- ¿dónde aparece anticipación o retraso sistemático?;
