...
Pasar de reconocer una agrupación concreta a **leer, sentir, escribir, transformar e improvisar varias agrupaciones dentro de 4/4**.

La unidad trabaja dos escalas:
...
- conservar 4/4 y el pulso de negra;
- reconocer que las unidades siguen siendo corcheas o semicorcheas normales;
- marcar inicios de grupo con acento sin convertir cada grupo en un nuevo compás;
- recuperar la cuadrícula después de un error;
- leer y escribir varias particiones correctas.

## AMPLIACIÓN

- liderar con ambas manos;
- cambiar dinámica sin cambiar la agrupación;
- orquestar los inicios de grupo en kit;
- alternar un compás neutro y otro agrupado;
- transformar una misma partición manteniendo constante su suma total.

## AVANZADO

- sostener una referencia corporal o auditiva de negra mientras la superficie acentual es muy asimétrica;
- usar agrupaciones como recurso formal de tensión/resolución;
- superponer una referencia de backbeat o ostinato sencillo sin perder la identidad del 4/4.

No se adelantan todavía ciclos cruzando barras, polimetría ni modulación métrica.
...
- 5–7 min: lectura/escritura o recuperación fría;
- 5–6 min: improvisación/composición o transferencia al kit;
- 1–2 min: registro del problema principal y siguiente prueba.

No es una plantilla rígida. La prioridad dominante de la sesión sigue mandando.
...
3. ejecutar al menos dos particiones no idénticas sin perder esa referencia;
4. leer y escribir una partición válida;
5. crear una frase breve donde la agrupación tenga una intención musical explicable;
6. continuar o recuperarse tras un error sin reiniciar automáticamente.

No se exige un BPM universal.