---
contentId: bat-f4-u9-overview
courseId: bateria
phase: 4
unit: 9
unitSlug: fase-4-unidad-9
slug: fase-4-unidad-9-introduccion
kind: unit
order: 0
...
La pregunta ya no es cuántas notas caben. La pregunta es si puedes **entrar en el lugar previsto, conservar el tiempo y aterrizar en el siguiente 1**.

## Dos fills esenciales

Trabajamos sólo dos duraciones:
