...
- identificas Groove A y la única diferencia de B;
- mantienes Groove A durante una frase breve;
- ejecutas B sin pérdida sistemática del pulso;
- sostienes una forma A–A–B–A reconocible;
- vuelves a A tras la variación;
- mantienes una subdivisión interna reconocible;
- un error aislado no obliga siempre a reiniciar;
- diagnosticas `BOMBO / PULSO / SUBDIVISIÓN / BALANCE / FORMA / RETORNO`;
- aplicas un correctivo de una variable y recompones;
- utilizas una grabación o evidencia equivalente para comparar al menos una toma;
- mantienes ergonomía, carga y escucha segura;
- explicas por qué la variación tiene un lugar y una función.

**No existe BPM de aprobado.** La perfección no es requisito para continuar.
