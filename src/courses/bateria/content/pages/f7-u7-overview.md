...
> **¿PUEDO SENTIR DOS “UNOS” QUE REGRESAN CON PERIODICIDADES DISTINTAS SIN PERDER LA LÍNEA TEMPORAL QUE COMPARTEN?**
...
- capa A: `3/4`;
- capa B: `4/4`;
- la negra conserva la misma duración en ambas;
- A reinicia cada 3 negras;
- B reinicia cada 4 negras;
- sus comienzos vuelven a coincidir después de 12 negras.

Por tanto:

`4 barras de 3/4 = 3 barras de 4/4 = 12 negras`

No hay cambio de tempo.
...
Métrica mixta es una sucesión temporal de compases, por ejemplo:

`4/4 → 5/4 → 7/8`

Polimetría implica capas métricas **simultáneas**.

### Polimetría ≠ compás impar

Una sola capa en `5/4` o `7/8` no es polimetría.
...
- saber que los `1` vuelven a coincidir en 12 negras;
- seguir una representación escrita de transporte sin confundirla con el fenómeno musical;
- recuperar una capa sin destruir la otra.

## AMPLIACIÓN

- `2/4 ↔ 3/4`;
- invertir manos/capas;
- reducir el click;
- mantener una capa vocal y otra manual;
- transformar el contenido interno de una métrica conservando su ciclo;
- transferir una capa a pies y otra a manos cuando haya kit.

## AVANZADO

- ciclos métricos más largos;
- métricas con unidades o agrupaciones más complejas;
- polimetría integrada en forma y ensemble;
...
- 3–4 min: una negra común + contar barras separadas;
- 7–9 min: `3/4 ↔ 4/4`;
- 6–8 min: cambio de foco y realineación;
- 5–6 min: lectura/escritura o aplicación;
- 2 min: grabación + diagnóstico.
...
3. mantener dos capas métricas sencillas sobre una referencia común;
4. saber dónde vuelven a coincidir sus comienzos;
5. leer o escribir un ejemplo breve;
6. cambiar el foco perceptivo sin colapsar una capa en la otra;
7. recuperar después de un error;
8. utilizar la relación con intención musical.
