---
contentId: bat-f2-u12-overview
courseId: bateria
phase: 2
unit: 12
unitSlug: fase-2-unidad-12
slug: fase-2-unidad-12-introduccion
kind: unit
order: 0
...
La formulación global es equivalente: poder enfrentarte a notación nueva básica sin convertirla primero en una secuencia memorizada.

## Qué evidencia importa

- lectura realmente nueva;
- pulso y subdivisión;
- continuidad;
- precisión;
- recuperación;
- comprensión suficiente de lo leído.

Oído/escritura aporta información diagnóstica adicional, pero **no crea un segundo examen**.
...
Cerrar Fase 2 no borra debilidades: las convierte en mantenimiento/correctivo mientras cambia el centro de gravedad hacia Fase 3 cuando sus prerrequisitos reales estén presentes.
