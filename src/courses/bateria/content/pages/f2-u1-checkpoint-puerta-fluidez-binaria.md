...
slug: puerta-de-fluidez-binaria
kind: checkpoint
order: 5
...
- puedes usar un click convencional en negras;
- elige un tempo cómodo para observar la tarea: el BPM describe la condición, no el nivel;
- no uses playback ni memorices la línea por fragmentos.

Después:

1. pulsa **Empezar**;
2. inspecciona brevemente el conjunto;
3. localiza pulso y subdivisión;
4. cuenta o canta si lo necesitas;
5. toca la línea completa con sticking alternado sencillo;
...
- **PRECISIÓN:** ataques, silencios y duraciones que coincidieron o no con la notación;
- **CONTINUIDAD / RECUPERACIÓN:** si mantuviste el flujo y si pudiste reincorporarte después de un error;
- **NECESIDAD DE CONTEO:** sin conteo, conteo interno o conteo/canto externalizado; necesitarlo no es un fallo por sí mismo;
- **VARIABLE LIMITANTE:** lectura, pulso, subdivisión, técnica, memoria, comprensión u otra observable.

Después del primer intento puedes usar playback y repetir como práctica/feedback. Esa repetición **ya no es primera vista**.
...
Sin volver a estudiar la partitura, responde con tus palabras:

> **¿Dónde estás subdividiendo aunque haya silencio?**

Una respuesta suficiente debe localizar el silencio **dentro de la rejilla temporal**: el ataque puede desaparecer, pero el pulso y la subdivisión interna continúan organizando cuándo podría ocurrir el siguiente ataque.

No buscamos una frase memorizada. Si puedes señalar o contar posiciones concretas dentro del pulso, la explicación es más útil que una definición abstracta.

## 4. Salud, carga y decisión — 1–2 min

Antes de aumentar novedad comprueba que no haya una señal que obligue a reducir o detener carga. Según el sistema general del curso, son señales relevantes:
...
Aparece una señal de salud/carga según el sistema general. Se detiene o reduce la carga antes de perseguir la progresión curricular.

## Qué significa “suficientemente disponible”

Para **CONTINUAR** o **CONTINUAR + CORRECTIVO**, la evidencia conjunta debería permitirte, con ayuda razonable cuando la necesites:

- localizar pulso y subdivisión en material binario elemental nuevo;
- contar o cantar sin que hacerlo se considere un fallo;
- tocar sin memorizar previamente toda la secuencia;
- mantener una continuidad razonable;
- recuperar después de un error pequeño o localizar por qué no pudiste hacerlo;
- identificar qué variable limitó el intento;
- explicar ataques, silencios y subdivisión dentro de la rejilla temporal.
...
- tempo fijo o alto;
- lectura rápida;
- PAS funcionales adicionales;
- prescindir del conteo;
- superar ya el Hito 2 global de Fase 2.
