...
Toca la versión íntegra en caja.

### B — Distribución

Reparte la frase entre al menos dos superficies manuales. Mantén una regla clara.

### C — Retorno

Vuelve a caja sin cambiar deliberadamente el esqueleto rítmico.

### D — Diagnóstico

Si aparece un fallo, elige el cuello de botella principal:

`TIEMPO / ACCESO / SUPERFICIE / STICKING / DINÁMICA`
...
- [ ] la distribuyes entre al menos dos superficies manuales accesibles;
- [ ] el esqueleto temporal no se pierde sistemáticamente;
- [ ] distingues superficie, dinámica y acento;
- [ ] puedes mantener notas bajas/taps en una superficie estable mientras mueves algunos ataques cuando la tarea lo pide;
- [ ] identificas un cuello de botella principal si aparece;
- [ ] modificas una variable de forma coherente;
- [ ] vuelves a la versión base en caja;
- [ ] explicas qué rasgo de identidad permaneció.

No necesitas una toma perfecta. Necesitas evidencia suficientemente estable para añadir después una nueva extremidad sin que la distribución manual siga siendo completamente opaca.
...
- cambias entre 2–3 superficies con control razonable;
- adaptas altura/dinámica a respuestas distintas;
- conservas la identidad en más de una ruta;
