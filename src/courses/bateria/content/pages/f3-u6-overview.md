---
contentId: bat-f3-u6-overview
courseId: bateria
phase: 3
unit: 6
unitSlug: fase-3-unidad-6
slug: fase-3-unidad-6-introduccion
kind: unit
order: 0
...
Toda transformación debe poder responder:

- **SE CONSERVA:** …
- **CAMBIA:** …
- **OPERACIÓN:** …
- **¿SIGUE RELACIONADO CON A?:** …

No existe un porcentaje universal de identidad. Si ya no puedes rastrear una relación con A, puedes haber creado material nuevo válido; simplemente no lo llamaremos automáticamente desarrollo de A.
...
## Dos familias que debes distinguir

**Paramétricas / de superficie:** acento, dinámica y sticking pueden conservar exactamente el esqueleto de ataques y silencios.

**Estructurales:** variación local, fragmentación, extensión/reducción, desplazamiento y reagrupación cambian de forma más directa la organización temporal o perceptiva.

## Terminología que no se negocia
