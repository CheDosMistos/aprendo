...
> **¿PUEDO CAMBIAR CUÁNTAS PARTES IGUALES CABEN DENTRO DEL MISMO PULSO SIN CAMBIAR LA DURACIÓN DEL PULSO?**
...
Estas relaciones son las elegidas para esta unidad; no se presentan como las únicas notaciones posibles de todos los quintillos o septillos.
...
Cinco golpes organizados como frase sobre una cuadrícula existente no son automáticamente un quintillo. Para hablar de quintillo debe existir una relación temporal donde el espacio se divide en cinco partes iguales.
...
- mantener una negra de referencia estable;
- producir cinco y siete ataques razonablemente equidistantes dentro de un pulso;
- leer la indicación de tuplet y explicar qué espacio ocupa;
- distinguir 5/7 tuplets de agrupación y métrica impar;
- cambiar entre subdivisiones comunes y 5/7 sin acelerar el pulso;
- recuperar el pulso después de un error.

## AMPLIACIÓN

- comenzar con izquierda;
- reducir el click;
- cambiar acentos internos;
- introducir silencios conservando la rejilla interna;
- orquestar 5/7 en el kit;
- escribir células propias y comprobar que la duración total sigue siendo correcta.

## AVANZADO

- usar 5/7 y otras divisiones como vocabulario expresivo;
...
- 3–4 min: pulso + `2/3/4` como reactivación;
- 7–9 min: tuplet objetivo;
- 6–8 min: transición entre densidades;
...
3. mantener el pulso cuando cambia la cantidad de subdivisiones;
4. alternar subdivisiones comunes y tuplets de 5/7 con estabilidad suficiente;
5. leer o escribir una célula sencilla;
6. usar al menos una transformación musical sin perder equidistancia ni referencia.
