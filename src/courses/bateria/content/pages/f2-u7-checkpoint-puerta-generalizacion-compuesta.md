---
contentId: bat-f2-u7-check
courseId: bateria
phase: 2
unit: 7
unitSlug: fase-2-unidad-7
slug: puerta-generalizacion-compuesta
kind: checkpoint
order: 5
...
1. una muestra escrita nueva y exclusiva con 6/8, 9/8 y 12/8;
2. una muestra auditiva nueva y exclusiva con respuesta oculta.

La convergencia entre ambas es más informativa que acertar una sola tarea. Un BPM describe la **condición de la muestra**, nunca el nivel por sí solo.

## 1. Muestra escrita exclusiva — 6/8, 9/8 y 12/8 — 6–7 min
...
- compás 1: `6/8` — 6 posiciones de corchea;
- compás 2: `9/8` — 9 posiciones;
- compás 3: `12/8` — 12 posiciones.

En total hay **27 posiciones de corchea: 20 ataques y 7 silencios**. Los silencios cambian de posición entre pulsos para comprobar si la jerarquía permanece disponible cuando no suena cada subdivisión.

Antes de habilitar audio:

1. identifica la indicación de compás;
2. escribe o verbaliza `2×3`, `3×3` o `4×3`;
3. marca únicamente los pulsos principales;
4. subdivide internamente las tres partes de cada pulso, también donde existe silencio;
5. toca la muestra una vez sin playback;
6. si aparece un error local, intenta recuperar en el siguiente pulso principal seguro;
7. explica por qué las corcheas ordinarias de estos compases **no son tuplets 3:2**.

Condiciones:

- unidad de pulso prototípica: **negra con puntillo**;
- tempo visible `♩. = 80` y playback técnico `<sound tempo="120"/>`;
- sticking libre y cómodo: no se evalúa una digitación concreta;
- conteo o canto son ayudas permitidas si se registran;
- el tempo puede reducirse si mezcla demasiadas variables;
- playback sólo **después del intento propio**.
...
## 2. Explicación conceptual — 2–3 min

Responde con tus palabras.

### ¿Qué permanece al pasar de 6/8 a 9/8 y 12/8 en esta unidad?

Permanece la división prototípica del pulso principal en **tres subdivisiones ordinarias**. Cambia el número de pulsos grandes:

- `6/8 = 2×3`;
- `9/8 = 3×3`;
- `12/8 = 4×3`.

### ¿Qué diferencia simple de compuesto en los ejemplos prototípicos trabajados?

No el tamaño del numerador, sino la **división del pulso principal**:

- simple → `×2`;
- compuesto → `×3`.

### Si reacentúas internamente un compás, ¿cambia automáticamente la indicación métrica?

No.

> **AGRUPACIÓN / REAGRUPACIÓN ≠ CAMBIO DE COMPÁS.**

Los acentos pueden crear otra agrupación perceptiva dentro de un metro regular sin reescribir por sí solos el compás subyacente.

### ¿Por qué `×3` no significa automáticamente «tresillo»?
...
`PULSOS PRINCIPALES / ×2 o ×3 / SIMPLE-COMPUESTO / COMPÁS PROTOTÍPICO`.

### Estímulo A

<div data-rhythm-dictation data-bpm="72" data-subdivision="3" data-pattern="101110" data-answer="6/8 prototípico — 2 pulsos principales × 3 subdivisiones: compuesto."></div>
...
<div data-rhythm-dictation data-bpm="72" data-subdivision="3" data-pattern="110101011" data-answer="9/8 prototípico — 3 pulsos principales × 3 subdivisiones: compuesto."></div>

### Estímulo D

<div data-rhythm-dictation data-bpm="72" data-subdivision="3" data-pattern="101110011101" data-answer="12/8 prototípico — 4 pulsos principales × 3 subdivisiones: compuesto."></div>

En cada respuesta registra también:

- número de escuchas antes de decidir;
- certeza `ALTA / MEDIA / BAJA`;
- si la respuesta surgió de sentir el pulso o de contar posiciones una por una;
- si pudiste justificarla antes de revelar.

Una respuesta aislada incorrecta **no bloquea automáticamente** el avance. Importa si existe un patrón sistemático de confusión o si puedes localizar y corregir la variable después de una repetición sin mirar la respuesta.

## 4. Evidencia secundaria sólo si hay discrepancia — 1–2 min

No añadas tareas por costumbre. Usa esta microtarea únicamente si lectura, explicación y oído ofrecen evidencia contradictoria.

Escribe un compás elemental nuevo de una de estas tres organizaciones:
...
- usa una rejilla de corcheas y algún silencio;
- conserva exactamente 6, 9 o 12 posiciones según la organización elegida;
- marca los pulsos principales antes de tocar;
- explica la relación entre número de posiciones y jerarquía;
- identifica el resultado como **EJERCICIO ORIGINAL PROPIO**, no como transcripción ni material de una fuente externa.

La finalidad es separar un posible problema de **representación** de uno de lectura o percepción.

## 5. Validez de la evidencia y salud — 1 min
...
- puedes leer la muestra exclusiva de 6/8, 9/8 y 12/8 sin playback previo;
- conservas respectivamente **2, 3 y 4 pulsos principales**, todos con subdivisión ternaria ordinaria;
- los silencios no destruyen sistemáticamente la rejilla interna;
- puedes explicar `6/8 = 2×3`, `9/8 = 3×3` y `12/8 = 4×3` como modelos prototípicos;
- distingues `×2` simple de `×3` compuesto en ejemplos claros;
- distingues subdivisión compuesta ordinaria de tuplet `3:2`;
- distingues agrupación/reagrupación de cambio automático de compás;
- en la muestra auditiva predomina la clasificación coherente y puedes localizar cualquier error aislado antes de mirar la respuesta;
- A/B no se resuelve sólo por «hay seis posiciones», sino por su relación con el pulso de entrada;
- identificas la variable limitante dominante y una acción correctiva concreta si procede;
- no existe una señal de salud/carga que invalide la muestra.
