...
## Bloque C — decisión de orquestación
...
- la frase base es reconocible;
- distribuyes material conocido entre al menos dos superficies de forma deliberada;
- conservas pulso y subdivisión razonables;
- la versión con pies mantiene bombo 1/3 y chick 2/4 sin colapso sistemático;
- distingues acento, dinámica y superficie;
- identificas una transición física problemática si aparece;
- aplicas un correctivo y recompones pronto;
- explicas al menos una elección tímbrica;
- conservas sticking cuando ayuda o lo cambias deliberadamente cuando no;
- no aumentas densidad sólo para hacer la tarea más difícil;
- mantienes ergonomía, carga y escucha segura.

**No existe BPM de aprobado.** La perfección no es requisito para avanzar.
