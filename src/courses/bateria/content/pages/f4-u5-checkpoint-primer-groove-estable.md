...
1. Toca el Groove Base A durante cuatro compases a tempo cómodo.
2. Mantén hi-hat en corcheas, caja en 2/4 y bombo en 1/3.
3. Si aparece un error aislado, intenta conservar o recuperar el pulso antes de detenerte.
4. Después de la frase, identifica la capa o transición que más se degradó.
...
- recuperas una referencia temporal clara cuando es posible;
- identificas un fallo recurrente concreto;
- aplicas un correctivo y vuelves al groove completo;
- mantienes ergonomía/carga sostenibles;
- explicas por qué **saber el patrón no equivale a mantener el groove**.
