---
contentId: bat-f3-u7-overview
courseId: bateria
phase: 3
unit: 7
unitSlug: fase-3-unidad-7
slug: fase-3-unidad-7-introduccion
kind: unit
order: 0
...
Una restricción reduce variables sin escribir por ti la respuesta. Puede fijar:

- un motivo;
- una transformación disponible;
- longitud de frase;
- densidad;
- silencio;
- retorno a A;
- dos transformaciones posibles;
- un objetivo formal o dinámico.

No es una estética obligatoria. La retiramos cuando deja de aportar aprendizaje.
...
↓
`call-and-response + marco fijo`
↓
`densidad / espacio`
↓
`2 transformaciones posibles`
↓
...
## Cuatro cosas que evaluamos por separado

- **CONTINUIDAD:** ¿el tiempo y la frase siguieron?;
- **CONTENIDO:** ¿hubo motivo, transformación, contraste, espacio o dinámica intencionales?;
...
- no pares para corregir cada error;
- simplifica si hace falta;
- recupera el pulso/frase;
- analiza después.
...
Improvisar una frase corta respetando una restricción clara y conservar suficiente marco temporal para que la frase siga siendo interpretable.
