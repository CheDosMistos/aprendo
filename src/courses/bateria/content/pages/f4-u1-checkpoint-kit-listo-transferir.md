...
- [ ] asiento y piezas principales están ajustados de forma sostenible para la tarea actual;
- [ ] puedes alcanzar caja y al menos una superficie adicional sin una pérdida evidente y repetida de equilibrio;
- [ ] ambos pies disponen de posiciones útiles para las futuras unidades de pedal, sin exigir todavía una técnica concreta;
- [ ] puedes explicar al menos un ajuste realizado y qué problema intentaba resolver;
- [ ] dispones de una estrategia básica de escucha segura apropiada a tu contexto;
- [ ] sabes que dolor persistente, hormigueo, entumecimiento o pérdida de fuerza/control no se normalizan y requieren reducir/detener la carga; si persisten, valoración profesional;
- [ ] reconoces que distintas superficies cambian rebote, ataque y respuesta;
...
- tocar fuerte;
- velocidad alta;
- una geometría de montaje copiada de otro baterista;
- ángulos o centímetros universales;
- fotos o vídeo del alumno;
- una partitura compleja de drumset.

## Prueba breve de salida

### A — Configuración

Siéntate y realiza una comprobación tranquila de caja, una superficie adicional y posiciones de pies.

Explica una decisión de montaje:

`PROBLEMA → CAMBIO → EFECTO`

Si no fue necesario cambiar nada, explica qué observaste para decidir mantenerlo.

### B — Superficie

Usa la misma célula manual conocida:

1. caja;
2. otra superficie completa;
3. vuelve a caja.

No repartas notas entre superficies todavía.

### C — Diagnóstico

Si algo falla, identifica una categoría principal:
...
- reajustas los componentes principales con poca ayuda;
- mantienes acceso razonable durante una práctica moderada;
- detectas cuándo un cambio mejora una zona pero empeora otra;
...
Optimizar configuración para distintos contextos, superficies, técnica y sonido queda como desarrollo posterior. No es una condición de Fase 4 inicial.
