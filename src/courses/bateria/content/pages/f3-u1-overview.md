---
contentId: bat-f3-u1-overview
courseId: bateria
phase: 3
unit: 1
unitSlug: fase-3-unidad-1
slug: fase-3-unidad-1-introduccion
kind: unit
order: 0
...
El eje nuevo no son figuras más difíciles. Es la **transferencia entre representaciones**.

`OÍR ↔ IMITAR ↔ ESCRIBIR ↔ LEER/TOCAR ↔ COMPARAR ↔ EXPLICAR`

No todas las tareas recorren siempre el ciclo entero. Una sola variable domina cada ejercicio.

## Cinco términos que no vamos a mezclar
...
- material breve y rítmicamente accesible;
- pulso y subdivisión suficientemente estables para diagnosticar;
- distinguir oído, memoria, notación y ejecución;
- registrar ayudas;
- explicar qué se conserva y qué cambia.

## AMPLIACIÓN

Si el núcleo está estable, puedes probar otra célula equivalente, otra dinámica o una segunda variante A′.
