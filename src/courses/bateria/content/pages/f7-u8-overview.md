...
- **AVANZADO:** integrar modulaciones múltiples dentro de forma musical compleja.

La pregunta central es:

> **¿PUEDO CONSERVAR UNA DURACIÓN EXACTA Y USARLA COMO PUENTE PARA DEFINIR UN NUEVO PULSO?**
...
Si la negra antigua está a `120 BPM`:

- una negra antigua contiene **3** corcheas de tresillo;
- una negra nueva contiene **2** corcheas nuevas;
- como ambas corcheas tienen la misma duración física, la negra nueva dura `2/3` de la negra antigua;
- por tanto:
...
Un tuplet es una división temporal dentro de una referencia. Puede servir de puente para una modulación, pero tocar un tresillo o quintillo no constituye por sí mismo una modulación.
...
No memorices una lista de BPM. Usa siempre esta secuencia:

1. **nombra la duración puente**;
2. **escribe la igualdad** entre duración antigua y nueva;
3. **cuenta cuántas unidades puente forman la negra antigua**;
4. **cuenta cuántas forman la negra nueva**;
5. deduce la razón entre ambas negras;
6. calcula el nuevo BPM;
7. comprueba después si el oído y las manos conservan realmente el puente.
...
- negra nueva = 2;
- nueva negra = `2/3` de la antigua;
- nuevo BPM = antiguo × `3/2`.

### Caso 5:4

`semicorchea de quintillo antigua = semicorchea nueva`

- negra antigua = 5 unidades puente;
- negra nueva = 4;
- nueva negra = `4/5` de la antigua;
- nuevo BPM = antiguo × `5/4`.
...
- ejecutar una relación `3:2` audible sin que el cambio sea un salto arbitrario de tempo;
- reconocer cuándo una modulación ha fallado aunque el BPM final “parezca” correcto;
- recuperar una referencia fiable después de un error.

## AMPLIACIÓN

- relación `5:4`;
- dirección inversa de una relación ya comprendida;
- click reducido después de dominar la continuidad;
- escribir modulaciones propias a partir de una igualdad dada;
- transferencia de la duración puente entre manos, voz y pies.

## AVANZADO

- cadenas de varias modulaciones;
- puentes con otras figuras y tuplets;
- modulaciones integradas en forma larga;
...
- 4 min: pulso + subdivisión puente;
- 7–8 min: igualdad temporal y transición lenta;
- 6–8 min: cálculo + ejecución;
- 5–6 min: lectura/escritura o aplicación;
- 2–3 min: grabación + diagnóstico.
...
3. calcular una relación sencilla;
4. ejecutar al menos una modulación con continuidad audible;
5. distinguirla de un mero cambio de BPM o de subdivisión;
6. leer o representar una modulación breve;
7. recuperar si pierdes el puente;
8. utilizar la modulación con una función musical clara.
