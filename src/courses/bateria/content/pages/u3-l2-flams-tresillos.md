---
contentId: bat-f1-u3-l2
courseId: bateria
phase: 1
unit: 3
unitSlug: unidad-3
slug: leccion-2-flams-tresillos
kind: lesson
order: 2
title: Lección 2 — Tresillos, Flam Tap y Flam Accent
summary: Profundiza la lectura estructurada de tresillos y acentos y añade Flam Tap y Flam Accent con atención a preparación de alturas y grace notes.
duration: 25–30 min
competencies: [A4, A5, A6, B3, C1, C2, C4, D1, D3, E2, F1, F2, K2, K6]
rudiments: [Flam Tap, Flam Accent]
published: true
---

## Objetivo

Leer y sentir **tresillos de corchea en 4/4**, mover acentos dentro de esa rejilla y presentar **Flam Tap** y **Flam Accent** desde su fuente normativa sin copiar su partitura.
...
<div data-notation-score data-score-src="/bateria/notation/u3/tresillos-acentos.musicxml" data-score-title="Tresillos y posiciones de acento" data-score-badge="EJERCICIO ORIGINAL CREADO PARA ESTE CURSO"></div>

El compás y la subdivisión no cambian. Lo que cambia es la **posición del acento dentro de cada tresillo**. Usa **VER → CONTAR → CANTAR → TOCAR → ESCUCHAR**. Primero sticking alternado; después líder contrario si mantiene calidad.

## 4. Preparación de grace note y principal — 4 min
...
Localiza **22. Flam Tap** directamente en PAS:

[PAS — International Drum Rudiments](https://pas.org/wp-content/uploads/2024/04/pas-rudiments.pdf)

Observa qué exige a la preparación de la mano después de cada principal. La secuencia debe aprenderse desde la partitura oficial, no desde una reconstrucción textual del curso.
...
- 3 min recuperación;
- 6 min tresillos/acentos;
- 4 min preparación técnica;
- 5 min Flam Tap;
- 5 min Flam Accent;
- 2 min teoría/registro.